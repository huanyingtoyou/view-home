...
import com.lihy.view.sharding.application.ShardingServiceJavaApplication;
...
@SpringBootTest(classes = ShardingServiceJavaApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
